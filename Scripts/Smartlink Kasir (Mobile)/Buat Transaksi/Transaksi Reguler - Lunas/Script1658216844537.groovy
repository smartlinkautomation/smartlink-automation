...
for (int i = 1; i <= 24; i++) {
    ...
    Mobile.tap(findTestObject('Kasir/Buat Transaksi/Lunasi Saat ini'), 0)

    Mobile.tap(findTestObject('Kasir/Buat Transaksi/Pilih Metode'), 0)

    Mobile.tap(findTestObject('Kasir/Buat Transaksi/Tunai'), 0)

    Mobile.tap(findTestObject('Kasir/Buat Transaksi/Sesuai Tagihan'), 0)

    Mobile.tap(findTestObject('Kasir/Buat Transaksi/Simpan Pembayaran'), 0)

    Mobile.tap(findTestObject('Kasir/Buat Transaksi/Bayar'), 0)
