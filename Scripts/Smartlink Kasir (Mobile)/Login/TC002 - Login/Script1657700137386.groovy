...
Mobile.startExistingApplication('com.sinadme.kasirsinadme', FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Kasir/Login/Alert empty'), 10)
